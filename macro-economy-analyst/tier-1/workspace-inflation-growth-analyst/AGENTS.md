...
**Input Source:**
- `/home/node/.openclaw/shared/data/processed/daily-brief.md` - Daily economic brief

**Output Target:**
- `/home/node/.openclaw/shared/analysis/macro-fundamentals/inflation-growth-analysis.md` - Analysis report

### Analysis Protocol

1. Read daily brief from input path
2. Extract inflation metrics and related data
