...
3. **If new or updated data is detected:**
   ...
   - Run the full commodities analysis pipeline (as defined in `SOUL.md`)
   - Overwrite `/home/node/.openclaw/shared/analysis/asset-specialists/commodities.md` with fresh analysis
