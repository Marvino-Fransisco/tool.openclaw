...
2. Run the full commodities analysis pipeline (as defined in `SOUL.md`)
3. Overwrite `/home/node/.openclaw/shared/analysis/asset-specialists/commodities.md` with fresh analysis
